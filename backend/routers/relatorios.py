...
def exportar_equipe_pdf(
    ...
    # Modalidade pode vir diretamente no parâmetro (filtro sem atleta selecionado)
    # ou ser inferida pelo atleta selecionado
    modalidade_filtro = modalidade or None

    if not modalidade_filtro and atleta_id:
